...
// Elementos nesesarios para desarrolar el programa
...
using namespace std;
  ...
  cout<< "distribuidora de café en grano la montaña S.A de C.V" <<endl;
  ...
  cout<< "Por favor ingrese la cantidad de sacos de café que desa comprar" <<endl;
